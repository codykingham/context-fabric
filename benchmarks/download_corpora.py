...
CORPORA: dict[str, dict[str, str]] = {
    "bhsa": {
        "source": "~/github/etcbc/bhsa/tf/2021",
        "description": "Biblia Hebraica Stuttgartensia Amstelodamensis",
        "language": "Hebrew",
...
def main():
    ...
    # Remove old bhsa-2021 if it exists (we're replacing with new structure)
    old_bhsa = corpora_dir / "bhsa-2021"
    if old_bhsa.exists():
        print(f"\nRemoving old bhsa-2021 directory...")
        shutil.rmtree(old_bhsa)
